...
Clock.activate = function(state) {
	...
	tmp = this1;
	Clock.view = tmp;
	var this2 = Clock.view;
	var v = atom.config.get("clock.icon");
	if(v) this2.classList.add("icon-clock"); else this2.classList.remove("icon-clock");
	v;
	Clock.configChangeListener = atom.config.onDidChange("clock",{ },function(e) {
		...
		var this3 = Clock.view;
		var v1 = e.newValue.icon;
		if(v1) this3.classList.add("icon-clock"); else this3.classList.remove("icon-clock");
		v1;
